...
public class Screen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vehicle Boo");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 255, 255));
        jLabel2.setText("king System");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/p6.jpg"))); // NOI18N

        jProgressBar1.setBackground(new java.awt.Color(204, 204, 255));
        jProgressBar1.setFont(new java.awt.Font("Times New Roman", 3, 12)); // NOI18N
        ...
        setSize(new java.awt.Dimension(715, 529));
